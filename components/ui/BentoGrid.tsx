...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    const text = "israeloloyede002@gmail.com";
    ...
    >
      ...
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
        ...
        >
          ...
          {id === 3 && (
          <div className="absolute -right-3 lg:-right-2">
            <div className="tech-stack-container flex gap-1 lg:gap-5 w-fit p-2 rounded-xl bg-[#0B0E24]">
